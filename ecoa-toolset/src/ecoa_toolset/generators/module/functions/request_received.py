...
"""Request Received generation class.
"""
...
from ecoa_toolset.models.components import Parameter, RequestReceived
from ecoa_toolset.models.ecoa_objects import ecoa_types_2_0


class RequestReceivedGenerator(FunctionGenerator):
    """"""
    ...
    def _generate_prototype(self, element: RequestReceived) -> str:
        ...
        generation += element.name + "__request_received (" + Common.LINE_BREAK[:1]
    ...
    def generate(self, element: RequestReceived) -> str:
        """"""
        generation = ""
        if self.body:
